...
export default function ItemBlock( {item} : {item: ItemConfig} ) {
  ...
  return (
    <div onMouseEnter={() => setMouseOver(true)} onMouseLeave={() => setMouseOver(false)} className="border border-black rounded-2xl aspect-[11/14] py-6 px-4 hover:scale-105 duration-200 ease-linear relative bg-blue-50">
